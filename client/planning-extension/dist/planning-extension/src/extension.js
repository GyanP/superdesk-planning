...
var assignments_overview_1 = require("./assignments-overview");
...
var extension = {
    activate: function (superdesk) {
        var _a;
        var extensionConfig = superdesk.getExtensionConfig();
        var result = {
            contributions: {
                entities: {
                    article: {
                ...
                globalMenuHorizontal: ((_a = extensionConfig) === null || _a === void 0 ? void 0 : _a.assignmentsTopBarWidget) === true ? [assignments_overview_1.AssignmentsList] : [],
            },
        };
